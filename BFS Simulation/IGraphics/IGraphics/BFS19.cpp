...
int Q[1000]={0};
int xn[1000],flag1=0,src,yp[1000]={0},ax[1000],ay[1000],bx[1000],by[1000],fx,fy,final=0,check;//,yn[1000]={0};
int cx,cy,cz;
...
void iDraw()
{
	...
	iSetColor(0,250,0);
	iText(200,80,"press 'n' for node :: 'e' for edge :: 's' for starting node :: 'p' for process :: 'd' for destination");
	//flag1=0;
	if(switch_node)
	{
		if(i!=0)
