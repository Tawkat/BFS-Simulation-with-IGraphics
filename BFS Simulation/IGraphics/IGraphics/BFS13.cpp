...
int mouseX, mouseY,node=0,a=0,i=0,j=0,z,y,switch_node=0,edge_node=0,source_node=0,process=0,bfs_path=0,mX[50],mY[50],eX[50],eY[50],c1[50],sx,sy,edge,vertex[50],parent[100],v1,v2,flag=0,w=1,flag2=0;
char clear=0;
//*********
...
void iDraw()
{
		...
		if(flag3==1)
	{
		mx=ax[i1],my=ay[i1],nx=bx[i1],ny=by[i1];
			x1=mx,k1=my,x2=nx,y2=ny,p,c=my-((ny-my)/(nx-mx))*mx;
			dx=x1;
			dy=k1;
			flag3=0;
				i1++;
