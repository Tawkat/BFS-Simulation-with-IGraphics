...
void iDraw()
{
	...
	iText(500+244,360-150,"IV");	//	iFilledCircle(500+259,360-150)      //20
    iText(500+145,360-256,"V");		//	iFilledCircle(500+150,360-260,5);	//60
	iText(495,60,"VI");				//	iFilledCircle(500,65,5);			//down
	iText(500-155,360-257,"VII");	//	iFilledCircle(500-150,360-260,5);	//120
	iText(500-260,360-150,"VIII");	//	iFilledCircle(500-260,360-150,5);	//150
	iText(200,360,"IX");			//	iFilledCircle(205,360,5);			//left
	iText(500-255,360+145,"X");		//	iFilledCircle(500-260,360+150,5);	//210
	iText(500-150,360+250,"XI");	//	iFilledCircle(500-150,360+260,5);	//240
	iText(490,650,"XII");			//	iFilledCircle(500,655,5);			//up
	iSetColor(20,50,210);
	iFilledCircle(500,360,20);		//small
	iText(280,10,"Press 'A' for Analog, 'D' for Digital, 'End' for Exiting");
...
int main()
{
	...
	ph =(3-H)*30.0-30*M/60.0-30*S/3600.0+1/600.0+270+90;
     
	pm= (15-M)*6.0-S/60.0+1/10.0+270+90;
