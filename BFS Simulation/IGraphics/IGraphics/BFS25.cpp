...
int mouseX, mouseY,node=0,a=0,i=0,j=0,r1,h,z,y,switch_node=0,edge_node=0,source_node=0,des_node=0,process=0,bfs_path=0,mX[50],mY[50],eX[50],eY[50],c1[50],sx,sy,edge,vertex[50],parent[100],level[100],v1,v2,flag=0,w=1,flag2=0;
char clear=0;
//*********
...
double dx,dy;//dy=my;
int i1=1,flag3=1,flag4=1,flag6=1,bfs1=1;
...
void iDraw()
{
	...
	if(dx==nx && i1<=w){
	    ...
	    {
			printf("%d\n",r1);
		mx=mX[xn[r1]],my=mY[xn[r1]],nx=mX[xn[r1-1]],ny=mY[xn[r1-1]];
		//r1--;
		//iLine(mx,my,nx,ny);
			x1=mx,k1=my,x2=nx,y2=ny,p,c=(ny-((ny-my)/(nx-mx+0.00))*nx)+0.00;
			/*if(mx>nx)
