...
int mouseX, mouseY,node=0,a=0,i=0,j=0,z,y,switch_node=0,edge_node=0,source_node=0,process=0,bfs_path=0,mX[50],mY[50],eX[50],eY[50],c1[50],sx,sy,edge,vertex[50],parent[100],level[100],v1,v2,flag=0,w=1,flag2=0;
char clear=0;
//*********
